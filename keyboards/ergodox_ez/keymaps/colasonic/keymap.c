/* Colasonic RP2040 Dactyl-inspired layout for the ErgoDox EZ. */ 
...
static uint16_t selall_a_timer = 0;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  QK_GESC, KC_1, KC_2, TD(KC3_CTL), TD(KC4_CTL), KC_5, KC_NO, KC_NO, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
  KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_NO, KC_NO, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_EQL,
  KC_BSPC, SELALL_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_QUOT,
  KC_LSFT, LT(1,KC_Z), LT(2,KC_X), LT(3,KC_C), LT(4,KC_D), KC_V, KC_NO, KC_NO, KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, TD(CT_RSHFT),
  KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_LALT, KC_NO, KC_NO, KC_NO, KC_PGUP, KC_PGDN,
  KC_LCTL, KC_LALT, TT(4), KC_RCTL,
  LGUI_T(KC_HOME), KC_LBRC,
  OSL(2), OSL(1), TD(END_CTL), KC_DEL, KC_SPACE, KC_ENT
),

  [1] = LAYOUT_ergodox_pretty(
  KC_TILD, KC_EXLM, KC_AT, LCTL(LSFT(KC_3)), LALT(KC_F4), KC_PERC, KC_NO, KC_NO, KC_NUM, KC_SLSH, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
  KC_CALC, LALT(KC_3), LCTL(KC_W), LCTL(LSFT(KC_F)), ST_MACRO_0, ST_MACRO_1, KC_NO, KC_NO, KC_CLR, KC_P7, KC_P8, KC_P9, KC_MINS, KC_PIPE,
  KC_CAPS, LALT(KC_1), LALT(KC_R), LALT(KC_S), LSFT(KC_F9), ST_MACRO_2, LCTL(LSFT(KC_M)), KC_P4, KC_P5, KC_P6, KC_PLUS, KC_BSLS,
  TO(0), DM_RSTP, ST_MACRO_3, LCTL(KC_C), LCTL(LSFT(KC_Y)), LCTL(KC_V), KC_NO, KC_NO, _______, KC_P1, KC_P2, KC_P3, KC_EQL, KC_UNDS,
  KC_NO, KC_NO, KC_WBAK, KC_WFWD, KC_WFWD, KC_NO, KC_COMM, KC_DOT, KC_PSCR, KC_PAUSE,
  KC_WBAK, KC_WFWD, _______, _______,
  DM_REC1, KC_RBRC,
  LALT(LCTL(KC_DELETE)), QK_LEAD, DM_PLY1, _______, KC_P0, KC_P0
),

  [2] = LAYOUT_ergodox_pretty(
  ST_MACRO_13, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO, KC_NO, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
  _______, _______, LALT(KC_W), ST_MACRO_4, ST_MACRO_10, KC_LBRC, KC_NO, KC_NO, KC_RBRC, KC_INS, KC_UP, _______, KC_SCRL, KC_MUTE,
  KC_F12, LCTL(KC_F1), LCTL(LSFT(KC_R)), LCTL(KC_S), LCTL(KC_F3), LCTL(KC_F5), KC_RPRN, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_VOLU,
  TO(0), LALT(LSFT(KC_R)), ST_MACRO_5, ST_MACRO_6, ST_MACRO_9, LALT(KC_2), KC_NO, KC_NO, _______, _______, _______, _______, _______, KC_VOLD,
  KC_NO, KC_NO, _______, _______, LALT(LCTL(KC_END)), KC_NO, KC_NO, KC_NO, _______, _______,
  _______, _______, KC_EQL, _______,
  ST_MACRO_11, LGUI(KC_L),
  _______, LALT(LCTL(KC_END)), LLOCK, ST_MACRO_8, _______, _______
),

  [3] = LAYOUT_ergodox_pretty(
  _______, _______, _______, _______, _______, _______, KC_NO, KC_NO, _______, _______, _______, _______, _______, _______,
  _______, LCTL(KC_Q), _______, TD(KC_UP_CTL), _______, _______, KC_NO, KC_NO, _______, KC_MS_WH_UP, KC_MS_UP, KC_MS_WH_DOWN, _______, _______,
  ...
  TO(0), KC_LSFT, _______, _______, LALT(KC_DOWN), ST_MACRO_9, KC_NO, KC_NO, _______, _______, _______, _______, _______, _______,
  KC_NO, KC_NO, _______, _______, LLOCK, KC_NO, KC_NO, KC_NO, KC_PGUP, KC_PGDN,
  _______, _______, _______, _______,
  KC_HOME, _______,
  _______, LLOCK, TD(END_CTL), _______, KC_MS_BTN1, KC_MS_BTN2
),
  [4] = LAYOUT_ergodox_pretty(
  QK_GESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_NO, KC_NO, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
  KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_NO, KC_NO, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_EQL,
  KC_BSPC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
  KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TD(CT_RSHFT),
  KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_LALT, KC_NO, KC_NO, KC_NO, KC_PGUP, KC_PGDN,
  KC_LCTL, KC_LALT, _______, KC_RCTL,
  ST_MACRO_16, KC_LBRC,
  KC_LBRC, KC_RBRC, ST_MACRO_17, KC_DEL, KC_SPACE, KC_ENT
),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    if (record->event.pressed) {
      selall_a_timer = timer_read();
      return false;
    }
    if (timer_elapsed(selall_a_timer) < TAPPING_TERM) {
      tap_code(KC_A);
      return false;
    }
...
void end_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (stap_state.state) {
        ...
        case DOUBLE_TAP: register_code(KC_LCTL); register_code(KC_LALT); wait_ms(100); register_code(KC_HOME); break;
...
void end_reset(tap_dance_state_t *state, void *user_data) {
    switch (stap_state.state) {
        ...
        case DOUBLE_TAP: unregister_code(KC_HOME); wait_ms(100); unregister_code(KC_LALT); unregister_code(KC_LCTL); break;
